...
WebConfig _$WebConfigFromJson(Map json) => $checkedCreate(
      ...
      ($checkedConvert) {
        final val = WebConfig(
          ...
          imagePathFavicon: $checkedConvert('image_path_favicon', (v) => v as String?),
          imagePathMaskable: $checkedConvert('image_path_maskable', (v) => v as String?),
          faviconSize: $checkedConvert('favicon_size', (v) => (v as num?)?.toInt() ?? constants.kFaviconSize),
      ...
      fieldKeyMap: const {'imagePath': 'image_path', 'imagePathFavicon': 'image_path_favicon', 'imagePathMaskable': 'image_path_maskable', 'faviconSize': 'favicon_size', 'faviconIco': 'favicon_ico', 'outputPath': 'output_path', 'backgroundColor': 'background_color', 'themeColor': 'theme_color'},
    );
