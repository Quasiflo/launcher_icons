...
WebConfig _$WebConfigFromJson(Map json) => $checkedCreate(
      ...
      ($checkedConvert) {
        final val = WebConfig(
          ...
          imagePathMonochrome:
              $checkedConvert('image_path_monochrome', (v) => v as String?),
          imagePathMonochromeMaskable: $checkedConvert(
              'image_path_monochrome_maskable', (v) => v as String?),
          imagePathFaviconSvg:
              $checkedConvert('image_path_favicon_svg', (v) => v as String?),
          imagePathOpengraph:
              $checkedConvert('image_path_opengraph', (v) => v as String?),
          imagePathTwitter:
              $checkedConvert('image_path_twitter', (v) => v as String?),
          shortcutIcons: $checkedConvert(
              'shortcut_icons',
              (v) => (v as List<dynamic>?)
                  ?.map((e) => WebShortcutIcon.fromJson(e as Map))
                  .toList()),
          faviconSize: $checkedConvert('favicon_size',
              (v) => (v as num?)?.toInt() ?? constants.faviconDefaultSize),
          ...
          themeColorLight:
              $checkedConvert('theme_color_light', (v) => v as String?),
          themeColorDark:
              $checkedConvert('theme_color_dark', (v) => v as String?),
        );
        return val;
      },
      fieldKeyMap: const {
        'imagePath': 'image_path',
        'imagePathPwa': 'image_path_pwa',
        'imagePathMaskable': 'image_path_maskable',
        'imagePathMonochrome': 'image_path_monochrome',
        'imagePathMonochromeMaskable': 'image_path_monochrome_maskable',
        'imagePathFaviconSvg': 'image_path_favicon_svg',
        'imagePathOpengraph': 'image_path_opengraph',
        'imagePathTwitter': 'image_path_twitter',
        'shortcutIcons': 'shortcut_icons',
