...
AndroidConfig _$AndroidConfigFromJson(Map json) => $checkedCreate(
      ...
      ($checkedConvert) {
        final val = AndroidConfig(
          ...
          adaptiveIconMonochromeInset: $checkedConvert(
              'adaptive_icon_monochrome_inset',
              (v) => (v as num?)?.toInt() ?? 16),
          adaptiveIconRound:
              $checkedConvert('adaptive_icon_round', (v) => v as String?),
          notificationIcon:
              $checkedConvert('notification_icon', (v) => v as String?),
          notificationIconName: $checkedConvert('notification_icon_name',
              (v) => v as String? ?? 'ic_notification'),
        );
        return val;
      },
      fieldKeyMap: const {
        ...
        'adaptiveIconMonochromeInset': 'adaptive_icon_monochrome_inset',
