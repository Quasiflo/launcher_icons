...
MacOSConfig _$MacOSConfigFromJson(Map json) => $checkedCreate(
      ...
      ($checkedConvert) {
        final val = MacOSConfig(
          ...
          roundedCorners: $checkedConvert('rounded_corners', (v) => v as bool? ?? false),
      ...
      fieldKeyMap: const {'imagePath': 'image_path', 'roundedCorners': 'rounded_corners', 'liquidGlassLayers': 'liquid_glass_layers', 'removeLiquidGlass': 'remove_liquid_glass', 'backgroundColor': 'background_color', 'liquidGlassTranslucency': 'liquid_glass_translucency', 'liquidGlassSpecular': 'liquid_glass_specular', 'liquidGlassShadowKind': 'liquid_glass_shadow_kind', 'liquidGlassShadowOpacity': 'liquid_glass_shadow_opacity', 'liquidGlassBlur': 'liquid_glass_blur', 'liquidGlassLighting': 'liquid_glass_lighting', 'liquidGlassRefractivityEnabled': 'liquid_glass_refractivity_enabled', 'liquidGlassRefractivityDepth': 'liquid_glass_refractivity_depth', 'liquidGlassRefractivityStrength': 'liquid_glass_refractivity_strength', 'liquidGlassSpecularHighlightPlacement': 'liquid_glass_specular_highlight_placement'},
    );

Map<String, dynamic> _$MacOSConfigToJson(MacOSConfig instance) => <String, dynamic>{
